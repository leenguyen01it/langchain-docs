...
- **Lộ trình học**: nội dung biên soạn thêm (không phải bản dịch), [Lộ trình trở thành AI Engineer](roadmap/index.md) gồm 10 track, 52 bài học: Nền tảng kỹ thuật, Hiểu LLM, Prompt & Context Engineering, RAG, Agents, Evaluation, LLMOps, Thiết kế sản phẩm & UX, Case study thiết kế hệ thống, ML nền tảng & Fine-tuning.
